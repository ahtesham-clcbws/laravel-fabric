...
class Table extends Component
{
    ...
    /**
     * 🧬 FORGED BY FABRIC
     * Handles state for searching, sorting, and filtering Category records.
    ...
    public function mount()
    {
        ...
        $this->columnVisibility = ['name' => true, 'description' => true];

        if ($recordId = request('record')) {
             $this->dispatch('openModal', [
                 'component' => 'App\Livewire\Fabric\Category.CategoryEditor',
    ...
    {
        return view('livewire.fabric.category.table', [
    ...
    {
        $filename = "Category_" . now()->format('Y-m-d_His') . ".csv";
        $headers = [
        ...
        $columns = ['id', 'name', 'description', 'created_at']; // Customizable
