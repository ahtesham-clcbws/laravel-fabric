...
class Table extends Component
{
    ...
    /**
     * 🧬 FORGED BY FABRIC
     * Handles state for searching, sorting, and filtering Service records.
    ...
    protected $listeners = ['service-saved' => '$refresh'];
    ...
    public function mount()
    {
        ...
        if ($recordId = request('record')) {
             $this->dispatch('openModal', [
                 'component' => 'App\Livewire\Fabric\Service.ServiceEditor',
        ...
        return Service::query()
            ...
            ->when($this->search, function ($query) {
                $query->where(function ($q) {
                    ...
                    $q->orWhere('icon', 'like', "%{$this->search}%");
    ...
    {
        return view('livewire.fabric.service.table', [
    ...
    {
        $filename = "Service_" . now()->format('Y-m-d_His') . ".csv";
        $headers = [
        ...
        $columns = ['id', 'title', 'description', 'icon', 'slug', 'created_at']; // Customizable
