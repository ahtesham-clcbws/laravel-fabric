...
class Table extends Component
{
    ...
    /**
     * 🧬 FORGED BY FABRIC
     * Handles state for searching, sorting, and filtering Tag records.
    ...
    protected $listeners = ['tag-saved' => '$refresh'];
    ...
    public function mount()
    {
        ...
        $this->columnVisibility = ['name' => true, 'slug' => true];

        if ($recordId = request('record')) {
             $this->dispatch('openModal', [
                 'component' => 'App\Livewire\Fabric\Tag.TagEditor',
    ...
    {
        return view('livewire.fabric.tag.table', [
    ...
    {
        $filename = "Tag_" . now()->format('Y-m-d_His') . ".csv";
        $headers = [
        ...
        $columns = ['id', 'name', 'slug', 'created_at']; // Customizable
