...
class Editor extends ModalComponent
{
     ...
     */
    public array $form = [];
    public ?Testimonial $record = null;
    ...
    public function mount(Testimonial $record = null)
    {
        $this->record = $record ?: new Testimonial;
    ...
    {
        return view('livewire.fabric.testimonial.editor');
    }
}
