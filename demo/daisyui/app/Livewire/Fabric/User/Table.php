...
class Table extends Component
{
    ...
    /**
     * 🧬 FORGED BY FABRIC
     * Handles state for searching, sorting, and filtering User records.
    ...
    public function mount()
    {
        ...
        $this->columnVisibility = ['name' => true, 'email' => true];

        if ($recordId = request('record')) {
             $this->dispatch('openModal', [
                 'component' => 'App\Livewire\Fabric\User.UserEditor',
    ...
    {
        return view('livewire.fabric.user.table', [
    ...
    {
        $filename = "User_" . now()->format('Y-m-d_His') . ".csv";
        $headers = [
        ...
        $columns = ['id', 'name', 'email', 'created_at']; // Customizable
