<div x-data="{ open: false }" 
    ...
    <button @click="open = true" class="btn btn-ghost btn-sm gap-2 border border-base-300 px-4">
        ...
        <div 
            ...
            class="fixed inset-0 bg-base-300/80 backdrop-blur-sm z-100" 
            @click="open = false"
        ></div>
        ...
        <div 
            ...
            class="fixed inset-0 z-101 flex items-start justify-center pt-16 sm:pt-24 px-4"
        >        
        <!-- Search Box -->
        <div class="bg-base-100 w-full max-w-2xl rounded-2xl shadow-2xl overflow-hidden border border-base-300" @click.outside="open = false" @keydown.escape.window="open = false">
