...
it('can search for a CompanyResource', function () {
    ...
    Livewire::test('App\Livewire\Fabric\Admin\CompanyResource\\CompanyResourceTable')
...
it('can create a new CompanyResource', function () {
    Livewire::test('App\Livewire\Fabric\Admin\CompanyResource\\CompanyResourceEditor')
